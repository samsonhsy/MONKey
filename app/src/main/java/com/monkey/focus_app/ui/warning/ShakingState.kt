...
class ShakingState(
    ...
    suspend fun shake(animationDuration: Int = 50) {
        ...
        when (direction) {
            ...
            Direction.Up_THEN_DOWN -> shakeToUpThenDown(shakeAnimationSpec)
        }
    }
    ...
    private suspend fun shakeToUpThenDown(shakeAnimationSpec: AnimationSpec<Float>) {

            yPosition.animateTo(-strength.value, shakeAnimationSpec)
            yPosition.animateTo(0f, shakeAnimationSpec)
            yPosition.animateTo(strength.value / 2, shakeAnimationSpec)
            yPosition.animateTo(0f, shakeAnimationSpec)
    ...
    enum class Direction {
        LEFT, RIGHT, LEFT_THEN_RIGHT, RIGHT_THEN_LEFT, Up_THEN_DOWN
    }
}
...
fun Modifier.shakable(
    ...
    return graphicsLayer {
        ...
        translationY = state.yPosition.value
}
    }
